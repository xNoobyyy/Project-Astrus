...
namespace Player.Inventory {
    public class BowSlot : ItemSlot, IPointerClickHandler, IBeginDragHandler, IDragHandler, IEndDragHandler, IDropHandler {
        /// <summary>
        ...
        public new void OnPointerClick(PointerEventData eventData) {
            ...
            PlayerInventory.Instance.SetItem(index, new IronBow());
        }
        ...
        public new void OnDrop(PointerEventData eventData) {
            ...
            if (!(InventoryScreen.Instance.DraggingFrom.Item is BowItem)) {
